<?php
    ...
    $sqlUpdateComra = "UPDATE compra_ropas SET email_Usuario_Comprador = '".$usuario."', estado_compra = 'Negociacion' WHERE id_Ropa='".$id."'";
    $resultUpdateCompra = $conexion->query($sqlUpdateComra);
    $sqlEmailUsuarioVendedor = "SELECT email_Usuario_Vendedor FROM ropas WHERE id_Ropa='".$id."'";
