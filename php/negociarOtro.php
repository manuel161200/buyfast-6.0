<?php
    ...
    $sqlUpdateComra = "UPDATE compra_Otros SET email_Usuario_Comprador = '".$usuario."', estado_compra = 'Negociacion' WHERE id_Otro='".$id."'";
    $resultUpdateCompra = $conexion->query($sqlUpdateComra);
    $sqlEmailUsuarioVendedor = "SELECT email_Usuario_Vendedor FROM otros WHERE id_Otro='".$id."'";
