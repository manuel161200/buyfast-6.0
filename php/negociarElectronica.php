<?php
    ...
    $sqlUpdateComra = "UPDATE compra_electronicas SET email_Usuario_Comprador = '".$usuario."', estado_compra = 'Negociacion' WHERE id_Electronica='".$id."'";
    $resultUpdateCompra = $conexion->query($sqlUpdateComra);
    $sqlEmailUsuarioVendedor = "SELECT email_Usuario_Vendedor FROM electronicas WHERE id_Electronica='".$id."'";
